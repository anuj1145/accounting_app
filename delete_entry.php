...
<?php
        ...
        $get_user = "select * from product where id='$user'";
        $run_user = mysqli_query($con, $get_user);
        $row=mysqli_fetch_array($run_user);

      $cos_id=$row['cust_id'];
      $work=$row['pro_name'];
	  $wr_desc=$row['pro_desc'];
	  $amount=$row['pro_price'];
...
"/>
  ...
  <div class="footer"><div align="center" class="footer_text">&copy: copyright 2018 by Deal24</div></div>
...
$delete = "delete from product where id='$u_id'";
$delete_ent = "delete from entry where id='$u_id'";
