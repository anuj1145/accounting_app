...
.footer_text{
 ...
 <body>
  ...
  <center><h4>Customers List</h4></center>
  <div class="left_content">
			...
			<th align="center" style="width:140px;">City</th>
			<th align="center" style="width:50px;">Amount</th>
			<th align="center" style="width:50px;">Status</th>
			<th align="center" style="width:240px;">Action</th>
			</tr>
       ...
       $i=0;
		...
		while ($row_costumers=mysqli_fetch_array($run_costumers)){
	     ...
	     ?> 
			...
			<a href="addin_costumer.php?cos_id=<?php echo $cos_id; ?>">Add products</a>&nbsp;
			<br><br>
